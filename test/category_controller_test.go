...
import (
	...
	"ferri/golang-restful-api/model/domain"
...
func setpUpTestDB() *sql.DB {

	db, err := sql.Open("mysql", "root:root1234@tcp(localhost:3306)/belajar_golang_restful_api_test")
...
func TestCreateCategorySuccess(t *testing.T) {
	...
	assert.Equal(t, "android", responseBody["data"].(map[string]interface{})["name"])
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	assert.Equal(t, "android1", responseBody["data"].(map[string]interface{})["name"])
}
